...
\begin{bnf*}
    ...
    \bnfmore{\bnfor \bnftd{JumpIfTrue} \bnfsp \bnftd{$\mathbf{int}$}}\\
...
\begin{bnf*}
    ...
    \bnfmore{\bnfor \bnftd{typecheck} \bnfts{(}  \bnftd{$\mathbf{expr}$} \bnfts{,} \bnfsp \bnftd{$\mathbf{type}$} \bnfts{)} \bnfsp \bnftd{then} \bnfsp \bnftd{$\mbold{expr}$} \bnfsp \bnftd{else} \bnfsp \bnftd{$\mbold{expr}$}}\\
    \bnfmore{\bnfor \bnftd{if} \bnfsp \bnftd{$\mathbf{expr}$} \bnfsp \bnftd{then} \bnfsp \bnftd{$\mbold{expr}$} \bnfsp \bnftd{then} \bnfsp \bnftd{$\mbold{expr}$}}\\
    \bnfmore{\bnfor \bnftd{\{} \bnfsp \bnftd{$\mathbf{stmts}$} \bnfsp \bnftd{\}}}\\
